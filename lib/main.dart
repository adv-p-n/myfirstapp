...
import 'package:myfirstapp/views/notes/create_update_note_view.dart';
import 'package:myfirstapp/views/notes/notes_view.dart';
...
void main() {
  ...
  runApp(MaterialApp(
    ...
    routes: {
      ...
      createUpdateNoteRoute: (context) => const CreateUpdateNotes(),
    },
  ));
}
